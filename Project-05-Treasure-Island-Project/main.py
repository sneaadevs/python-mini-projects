...
if choice=="left":
    ...
    if choice1=="wait":
        ...
        if choice2=="red":
            print("You fell in firehole and died.Game over.")
        elif choice2=="yellow":
            print("You got stabbed by el gato cat and died.Game over.")
        else:
            print("You found the treasure and survived all the hurdles and Cat Pirates.YOU WON!")
else:
    print("You are eaten by scuba scuba cat.Game over.")
